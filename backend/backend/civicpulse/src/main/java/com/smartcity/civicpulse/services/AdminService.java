...
public class AdminService {
    ...
    public List<PendingComplaints> getPendingComplaints() {
        ...
        for(Complaint c : complaints)
        {
            PendingComplaints pc=new PendingComplaints(
                    c.getComplaintId(),c.getCitizen().getName(),c.getDescription(),c.getArea(),c.getCreatedDate());
    ...
    public void acceptComplaint(Long id) {
    ...
    public List<AllComplaints> getAllComplaints()
    {
        ...
        for(Complaint c : complaints)
        {
            AllComplaints ac=new AllComplaints(
                    c.getComplaintId(),c.getCitizen().getName(),c.getDescription(),c.getArea(),c.getCreatedDate(),c.getStatus());
